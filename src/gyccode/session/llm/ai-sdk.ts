import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@gyccode/llm"
...
// Move this extraction into @gyccode/llm when Copilot is handled by the native runtime.
