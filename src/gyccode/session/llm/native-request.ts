import type { JsonSchema, LLMRequest, ProviderMetadata } from "@gyccode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@gyccode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @gyccode/llm request objects from gyccode's session/AI SDK-shaped data.
  return LLM.request({
