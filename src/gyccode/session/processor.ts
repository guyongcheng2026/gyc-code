...
export class Service extends Context.Service<Service, Interface>()("@gyccode/SessionProcessor") {}
      ...
      const failToolCall = Effect.fn("SessionProcessor.failToolCall")(function* (toolCallID: string, error: unknown) {
        ...
        yield* session.updatePart({
          ...
          state: {
            ...
            metadata: "metadata" in match.part.state ? match.part.state.metadata : undefined,
