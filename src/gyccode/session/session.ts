...
import type { ProviderMetadata, Usage } from "@gyccode/llm"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".gyccode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@gyccode/Session") {}
