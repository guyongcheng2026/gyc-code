...
import { ProjectDirectories } from "@gyccode/core/project/directories"
...
export class Service extends Context.Service<Service, Interface>()("@gyccode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.GYCCODE_FAKE_VCS)
