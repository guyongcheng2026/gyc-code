...
import type { Event, GlobalEvent, OpencodeClient as GyccodeClient } from "@opencode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@gyccode/RunStreamTransport") {}
