...
type PromptModel = Parameters<GyccodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<GyccodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<GyccodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<GyccodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<GyccodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<GyccodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<GyccodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<GyccodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<GyccodeClient["question"]["reject"]>[0]
