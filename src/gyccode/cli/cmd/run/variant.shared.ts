...
//
// The saved variant persists across sessions in ~/.local/state/gyccode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@gyccode/RunVariant") {}
