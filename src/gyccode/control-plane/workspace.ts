...
import { EventSequenceTable, EventTable } from "@gyccode/core/event/sql"
...
import { WorkspaceTable } from "@gyccode/core/control-plane/workspace.sql"
...
import { WorkspaceEvent } from "@gyccode/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@gyccode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        GYCCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        GYCCODE_WORKSPACE_ID: config.id,
        GYCCODE_EXPERIMENTAL_WORKSPACES: "true",
