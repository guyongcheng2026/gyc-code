 ...
 *   "@gyccode/ServerAuthConfig",
 *   {
 *     password: Config.string("GYCCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("GYCCODE_SERVER_USERNAME").pipe(Config.withDefault("gyccode")),
 *   },
 * ) {}
 *
