...
>()("@gyccode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@gyccode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.GYCCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.GYCCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-gyccode-directory"] || process.cwd()
}
