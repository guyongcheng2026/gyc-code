...
import { GycCodeHttpApi } from "./api"
...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for gyccode serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(GycCodeHttpApi)
...
export const PublicApi = GycCodeHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "gyccode",
    version: "1.0.0",
    description: "gyccode api",
