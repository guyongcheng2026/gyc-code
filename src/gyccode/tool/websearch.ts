...
import { checksum } from "@gyccode/core/util/encode"
...
export function selectWebSearchProvider(sessionID: string, flags = { exa: false, parallel: false }): WebSearchProvider {
  const override = process.env.GYCCODE_WEBSEARCH_PROVIDER
...
function parallelAuthHeaders() {
  const headers = { "User-Agent": `gyccode/${InstallationVersion}` }
