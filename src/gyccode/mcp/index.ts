...
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/anomalyco/gyccode/issues/11948
    // sampling: {},
    // https://github.com/anomalyco/gyccode/issues/23066
    // elicitation: {},
    // https://github.com/anomalyco/gyccode/issues/2308
    roots: {},
    // https://github.com/anomalyco/gyccode/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "gyccode", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@gyccode/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: gyccode mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
...
export * from "./standard-elements.js"