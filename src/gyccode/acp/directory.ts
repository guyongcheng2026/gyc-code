...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@gyccode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@gyccode/ACPDirectory") {}
