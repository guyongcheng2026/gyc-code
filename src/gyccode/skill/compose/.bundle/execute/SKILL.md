...
**Note:** Tell your human partner that Compose works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (such as other agent CLIs). If subagents are available, use compose:subagent instead of this skill.
