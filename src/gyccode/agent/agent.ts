...
import { AbsolutePath, type DeepMutable } from "@gyccode/core/schema"
...
import { PluginV2 } from "@gyccode/core/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@gyccode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".gyccode", "plans", "*.md")]: "allow",
