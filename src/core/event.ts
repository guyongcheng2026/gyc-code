...
import type { Data, Definition, Payload } from "@gyccode/schema/event"
...
import { Durable } from "@gyccode/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@gyccode/schema/event").ID
export type { Data, Definition, Payload } from "@gyccode/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@gyccode/Event") {}
