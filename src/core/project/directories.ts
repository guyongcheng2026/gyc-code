...
import type { EffectDrizzleSqlite } from "@gyccode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@gyccode/ProjectDirectories") {}
