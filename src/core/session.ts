...
import { ListAnchor } from "@gyccode/schema/session"
...
import { SessionDurable } from "@gyccode/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@gyccode/v2/Session") {}
