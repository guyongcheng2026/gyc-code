...
import { Entry, FileSystem, FindInput, Match } from "@gyccode/schema/filesystem"
export { Entry, Match, Submatch } from "@gyccode/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@gyccode/v2/FileSystem") {}
