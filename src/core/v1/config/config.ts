...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: "Server configuration for gyccode serve and web commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see gyccode docs",
  }),
  ...
  ).annotate({ description: "Agent configuration, see gyccode docs" }),
  ...
  compaction: Schema.optional(
    Schema.Struct({
      ...
      microcompact: Schema.optional(Schema.Boolean).annotate({
        description: "Enable micro-compaction of middle tool outputs at high context usage (default: true)",
      }),
