import type { Event, createGyccodeClient, Project, Model, Provider, Permission, UserMessage, Message, Part, Config as SDKConfig } from "@gyccode/protocol/v1";
import type { Provider as ProviderV2, Model as ModelV2, Auth } from "@gyccode/protocol/v2";
