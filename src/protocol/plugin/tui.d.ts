import type { AgentPart, GyccodeClient, Event, FilePart, LspStatus, McpStatus, Todo, Message, Part, Provider, PermissionRequest, QuestionRequest, Session, SessionStatus, TextPart, Config as SdkConfig } from "@gyccode/protocol/v2";
...
export type TuiState = {
    ...
    session: {
        ...
        instructions: (sessionID: string) => ReadonlyArray<string>;
