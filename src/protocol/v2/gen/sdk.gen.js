...
class HeyApiRegistry {
    ...
    get(key) {
        ...
        if (!instance) {
            throw new Error(`No SDK client found. Create one with "new GyccodeClient()" to fix this error.`);
        }
        return instance;
    }
    set(value, key) {
...
export class GyccodeClient extends HeyApiClient {
    static __registry = new HeyApiRegistry();
    constructor(args) {
        super(args);
        GyccodeClient.__registry.set(this, args?.key);
    }
    _auth;
    get auth() {
