...
import type { Definition } from "@gyccode/schema/event"
...
export const GycCodeEvent = event.schema
export type GycCodeEvent = typeof GycCodeEvent.Type
export type GycCodeEventEncoded = typeof GycCodeEvent.Encoded
