...
import type { QuestionAnswer, QuestionRequest } from "@gyccode/protocol/v2"
import { useSDK } from "../../context/sdk"
import { SplitBorder } from "../../ui/border"
import { useTuiConfig } from "../../config"
import { useBindings, useGyccodeModeStack } from "../../keymap"
...
export function QuestionPrompt(props: { request: QuestionRequest; directory?: string }) {
  ...
  const modeStack = useGyccodeModeStack()
  ...
  useBindings(() => {
    ...
    return {
      ...
      bindings: [
        ...
        ...(confirm()
          ? [
              { key: "return", desc: "提交答案", group: "提问", cmd: () => submit() },
          ...
          : [
              ...
              { key: "down", desc: "下一个答案", group: "提问", cmd: () => moveTo((store.selected + 1) % total) },
              { key: "j", desc: "下一个答案", group: "提问", cmd: () => moveTo((store.selected + 1) % total) },
              { key: "return", desc: "选择答案", group: "提问", cmd: () => selectOption() },
              { key: "escape", desc: "拒绝提问", group: "提问", cmd: () => reject() },
              ...tuiConfig.keybinds.get("app.exit"),
            ]),
      ],
