...
import type { ProjectDirectories } from "@gyccode/protocol/v2"
    ...
    return list.map((item) => {
      ...
      return {
        ...
        titleView: isRemoving ? (
          ...
          <span style={{ fg: theme.text }}>再次按 {deleteHint()} 确认</span>
        ) : suffix ? (
          <>
        ...
        category: item.root.directory === current ? "当前" : "其他",
        titleWidth,
